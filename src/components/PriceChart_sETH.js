...
import{
	priceChartLoadedSelector_sETH,
	priceChartSelector_sETH
...
class PriceChart_sETH extends Component {
	render() {
		return(
...
function  mapStateToProps(state){
	...
	return{
		priceChartLoaded: priceChartLoadedSelector_sETH(state),
		priceChart: priceChartSelector_sETH(state),
	}
}

export default connect(mapStateToProps)(PriceChart_sETH)